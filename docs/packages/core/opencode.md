...
## opencode 专项架构文档 / Focused Architecture Docs
1. `docs/architecture/00-exploration-task.md`
2. `docs/architecture/01-overview.md`
3. `docs/architecture/02-system-design.md`
4. `docs/architecture/03-implementation-map.md`
5. `docs/architecture/04-plugin-client-event-analysis.md`
